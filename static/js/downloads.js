...
const URLStack = {
  ...
  getDownloadStat: (build, codename) => `https://sourceforge.net/projects/komodos-rom/files/${codename}/${build}/stats/json?start_date=2019-04-04&end_date=${dateUtils.getToday()}`,
  getDownload: (build, codename) => `https://downloads.sourceforge.net/project/komodos-rom/${codename}/${build}`,
}
